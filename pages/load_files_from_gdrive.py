...
def start_processing():
    ...
    try:
        ...
        st.info("Successfully processed all invoices!. Now you can proceed to the Chat Bot page to interact with the processed invoices.")
...
if not st.session_state.initialized:
    ...
    status.success("✅ Initialization complete. Kindly please wait while we start processing...")
